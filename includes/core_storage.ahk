...
T(key) {
    ...
    if (lang = "sv") {
        switch key {
            ...
            case "llm_max_tokens_hint": return "Min 128."
            ...
            case "llm_examples": return "Exempel..."
            case "llm_linked_examples": return "Kopplade exempel"
            case "llm_example_preview": return "Förhandsvisning"
            case "llm_add_example": return "Lägg till"
            case "llm_remove_example": return "Ta bort"
            case "llm_update_pricing": return "Uppdatera priser"
            case "llm_refresh_models": return "Uppdatera modellista"
            case "llm_pricing_last_updated": return "Priser uppdaterade"
            case "llm_models_last_updated": return "Modeller uppdaterade"
            case "llm_pricing_unknown": return "pris okänt"
            case "llm_pricing_updating": return "Hämtar priser..."
            case "llm_pricing_update_ok": return "Priser uppdaterade."
            case "llm_pricing_update_failed": return "Kunde inte uppdatera priser"
            case "llm_pricing_stale_notice": return "Prislistan är äldre än 30 dagar."
            case "llm_pricing_update_now": return "Uppdatera nu"
            case "llm_estimated_cost": return "Uppskattad kostnad"
    ...
    switch key {
        ...
        case "llm_examples": return "Examples..."
        case "llm_linked_examples": return "Linked examples"
        case "llm_example_preview": return "Preview"
        case "llm_add_example": return "Add"
        case "llm_remove_example": return "Remove"
        case "llm_update_pricing": return "Update pricing"
        case "llm_refresh_models": return "Refresh models"
        case "llm_pricing_last_updated": return "Prices updated"
        case "llm_models_last_updated": return "Models updated"
        case "llm_pricing_unknown": return "price unknown"
        case "llm_pricing_updating": return "Fetching prices..."
        case "llm_pricing_update_ok": return "Prices updated."
        case "llm_pricing_update_failed": return "Could not update prices"
        case "llm_pricing_stale_notice": return "Pricing list is older than 30 days."
        case "llm_pricing_update_now": return "Update now"
        case "llm_estimated_cost": return "Estimated cost"
...
ApplyStorageSelection() {
    ...
    global LLMPromptFile, LLMResponseLogFile, LLMExampleLinkFile
